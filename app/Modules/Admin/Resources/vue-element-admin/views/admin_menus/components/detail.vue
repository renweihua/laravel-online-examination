<template>
    ...
    >
        <el-form ref="form" :model="form" :rules="rules" label-width="105px">
            ...
            <el-form-item label="Vue名称（多语言定义）" prop="vue_name" v-if="false">
                <el-input v-model="form.vue_name" autocomplete="off"></el-input>
            </el-form-item>
            ...
            <el-form-item label="Vue的meta" prop="vue_meta" v-if="false">
